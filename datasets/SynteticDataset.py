...
class SynteticDataset(Dataset):
    def __init__(self, ground_truth: Dataset, transform: Callable = torch.nn.Identity()):
...
if __name__ == "__main__":
    ...
    dataset = SynteticDataset(
        ground_truth=BSDS500(path="data/BSDS500/train", transform=transforms.RandomCrop(size)),
